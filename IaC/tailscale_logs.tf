# Tailscale network-logs puller (function app) — superseded by the Sentinel
# codeless connector (CCF) in SentinelCCF/TailScale/mainTemplate.json, which pulls the
# logs directly via OAuth client-credentials. Kept commented for reference.
#
# locals {
